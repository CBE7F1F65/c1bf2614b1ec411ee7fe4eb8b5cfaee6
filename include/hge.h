...
public:
	...
	/*
	virtual void		CALL	Gfx_3DRenderStart() = 0;
	virtual void		CALL	Gfx_3DRenderEnd() = 0;
	*/
	...
	/*
	virtual void		CALL	Font_Print(HD3DFONT font, float x, float y, unsigned short align, DWORD color, unsigned short shadow, char *format, ...) = 0;
	virtual void		CALL	Font_Print(HD3DFONT font, float x, float y, float w, float h, unsigned short align, DWORD color, unsigned short shadow, char *format, ...) = 0;
	*/
