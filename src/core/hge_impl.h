...
public:
	...
	/*
	virtual void		CALL	Gfx_3DRenderStart();
	virtual void		CALL	Gfx_3DRenderEnd();
	*/
...
/*	//add by Thor/h5nc
	virtual void		CALL	Font_Print(HD3DFONT font, float x, float y, unsigned short align, DWORD color, unsigned short shadow, char *format, ...);
	virtual void		CALL	Font_Print(HD3DFONT font, float x, float y, float w, float h, unsigned short align, DWORD color, unsigned short shadow, char *format, ...);
	//delete by Thor/h5nc
